...
<div class="container">
    <form:form method="POST" modelAttribute="user" class="form-signin" action="/user/editsave">
        ...
        <spring:bind path="password">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:hidden path="password" class="form-control" placeholder="password" ></form:hidden>
